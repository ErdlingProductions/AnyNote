...
public class NoteProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match) {
            case NOTES:
                ...
                cursor = database.query(NoteEntry.TABLE_NOTES_NAME, projection, selection, selectionArgs, null, null, sortOrder);
                break;
            case NOTE_ID:
    ...
    public Uri insert(Uri uri, ContentValues contentValues) {
        Log.v("Test","started insert method");
        final int match = sUriMatcher.match(uri);
        switch (match) {
            case NOTES:
                return insertItem(uri, contentValues);
            default:
                Log.v("Test","insert method default error");
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        long id = database.insert(NoteEntry.TABLE_NOTES_NAME, null, values);
    ...
    private int updateItem(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int rowsUpdated = database.update(NoteEntry.TABLE_NOTES_NAME, values, selection, selectionArgs);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case NOTES:
                ...
                rowsDeleted = database.delete(NoteEntry.TABLE_NOTES_NAME, selection, selectionArgs);
                break;
            case NOTE_ID:
